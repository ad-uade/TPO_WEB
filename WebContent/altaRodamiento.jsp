					...
					<div class="row">
						<div class="col-sm-8">
							<div class="contact-form">
								...
								<form id="main-contact-form" class="contact-form row" action="./ControladorRodamientos" method="post" onsubmit="return validar();">
									...
									<div class="form-group col-md-12">
										...
										<input type="submit" name="submit" class="btn btn-primary pull-right" value="Procesar"></input>
									</div>
								</form>
							</div>
						</div>
